...
#define TECHNIQUE_PIXEL_ONLY(name, psname ) \
	technique name { pass Pass0 { PixelShader = compile ps_4_0_level_9_1 psname(); } }
...
// Macros for targetting shader model 3.0 (DX9)

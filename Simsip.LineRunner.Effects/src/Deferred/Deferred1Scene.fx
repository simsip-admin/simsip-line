...
PixelToFrame MultipleTargetsPixelShader(VertexToPixel PSIn)
{
	...
	Output.Color.rgb = SAMPLE_TEXTURE(Texture, PSIn.TexCoords);
...
TECHNIQUE( MultipleTargets,    MultipleTargetsVertexShader, MultipleTargetsPixelShader    );
TECHNIQUE( SingleTargetColor,  MultipleTargetsVertexShader, SingleTargetColorPixelShader  );
TECHNIQUE( SingleTargetNormal, MultipleTargetsVertexShader, SingleTargetNormalPixelShader );
TECHNIQUE( SingleTargetDepth,  MultipleTargetsVertexShader, SingleTargetDepthPixelShader  );

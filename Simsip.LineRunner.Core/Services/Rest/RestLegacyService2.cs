...
namespace Simsip.LineRunner.Services.Rest
{
    public class RestService : IRestService
    {
                                                   ...
                                                   RestVerbs verb)
        {
            ...
            {
                var response = await MakeRequestAsync(url, verb, content);
                return response;
            }
        }
                                                    ...
                                                    HttpContent content)
        {
            ...
            {
                /* TODO: Remove when scoreoid stable
                switch (oauthType)
                {
                    ...
                    case OAuthType.Groupme:
                        {
                            client.DefaultRequestHeaders.Add("X-Access-Token", App.GroupmeAccessToken);
                            break;
                        }

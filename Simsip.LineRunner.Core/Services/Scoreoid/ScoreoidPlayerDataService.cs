...
namespace Simsip.LineRunner.Services.Scoreoid
{
    ...
    /// </summary>
    public class ScoreoidPlayerDataService : IScoreoidPlayerDataService
    {

        private readonly IRestService _restService;

        public ScoreoidPlayerDataService()
        {
            _restService = new RestService();
        }

        #region IScoreoidPlayerDataService Implementation

        public async Task<PlayerDataEntity> GetPlayerDataAsync(string key)
        {
            throw new NotImplementedException();
        }

        public async Task SetPlayerDataAsync(PlayerDataEntity playerData)
        {
            throw new NotImplementedException();
        }

        public async Task UnsetGameDataAsync(PlayerDataEntity playerData)
        {
            throw new NotImplementedException();
        }

...
namespace Simsip.LineRunner.Services.Scoreoid
{
    ...
    /// </summary>
    public class ScoreoidGameService : IScoreoidGameService
    {

        private readonly IRestService _restService;

        public ScoreoidGameService()
        {
            _restService = new RestService();
        }

        #region IScoreoidGameService Implementation
        ...
        public Task<string> GetGameFieldAsync()
        {
            throw new NotImplementedException();
        }

        public Task<IList<PlayerEntity>> GetPlayersAsync()
        {
            throw new NotImplementedException();
        }

        public Task<int> GetGameTopAsync()
        {
            throw new NotImplementedException();
        }

        public Task<int> GetGameAverageAsync()
        {
            throw new NotImplementedException();
        }

        public Task<int> GetGameLowestAsync()
        {
            throw new NotImplementedException();
        }

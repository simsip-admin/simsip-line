...
namespace Simsip.LineRunner.Services.Scoreoid
{
    ...
    /// </summary>
    public class ScoreoidNotificationService : IScoreoidNotificationService
    {

        private readonly IRestService _restService;

        public ScoreoidNotificationService()
        {
            _restService = new RestService();
        }

        #region IScoreoidNotificationService Implementation

        public async Task<IList<NotificationEntity>> GetNotificationsAsync()
        {

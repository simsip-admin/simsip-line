...
namespace Simsip.LineRunner.Actions
{
    public class Repeat : ActionInterval
    {
        ...
        protected FiniteTimeAction m_pInnerAction;
        ...
        protected Repeat(Repeat repeat) : base(repeat)
        {
            var param = repeat.m_pInnerAction.Copy() as FiniteTimeAction;
        ...
        public bool InitWithAction(FiniteTimeAction action, uint times)
        {
            ...
            if (base.InitWithDuration(d))
            {
                ...
                m_bActionInstant = action is ActionInstant;
        ...
        public override object Copy(ICopyable zone)
        {
            if (zone != null)
            {
                ...
                var param = m_pInnerAction.Copy() as FiniteTimeAction;
                if (param == null)
                {
                    return null;
                }
        ...
        {
            return new Repeat(m_pInnerAction.Reverse(), m_uTimes);
        }
    }
}
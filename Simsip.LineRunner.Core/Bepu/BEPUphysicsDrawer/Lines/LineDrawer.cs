...
namespace BEPUphysicsDrawer.Lines
{
    ...
    public class LineDrawer
    {
        ...
        /// Draws the component.
        /// </summary>
        /// <param name="viewMatrix">ViewDirection matrix to use when rendering the lines.</param>
        /// <param name="projectionMatrix">ProjectionMatrix matrix to use when rendering the lines.</param>
...
#if !WINDOWS
#if NETFX_CORE
                var info = displayType.GetTypeInfo();
                var ctor = info.DeclaredConstructors.ToList()[0];
                LineDisplayObjectBase objectAdded = (LineDisplayObjectBase)ctor.Invoke(new object[] { o, this });

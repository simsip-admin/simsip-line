...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    /// </summary>
    public class FreeControllerInput : IControllerInput
    {
        /// <summary>
        ...
        public FreeControllerInput(Space owningSpace, Camera camera, Game game)
        {
            TheCamera = camera;
            TheCameraControlScheme = new  FreeCameraControlScheme(0f, camera, game);
        }

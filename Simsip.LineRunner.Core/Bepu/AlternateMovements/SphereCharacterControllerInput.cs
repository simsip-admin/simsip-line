...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    public class SphereCharacterControllerInput
    {
        ...
        public SphereCharacterControllerInput(Space owningSpace, Camera camera, Game game /*DemosGame game*/)
        {
        ...
        public void Activate()
        {
            if (!IsActive)
            {
                ...
                CharacterController.Body.Position = ConversionHelper.MathConverter.Convert(Camera.Position) - CameraControlScheme.CameraOffset;
            }
        }
        ...
        public void Update(float dt, KeyboardState previousKeyboardInput, KeyboardState keyboardInput, GamePadState previousGamePadInput, GamePadState gamePadInput)
        {
            if (IsActive)
            {
                ...
                CharacterController.ViewDirection = ConversionHelper.MathConverter.Convert(Camera.WorldMatrix.Forward);
            }
        }
    }
}
...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    /// </summary>
    public class TankControllerInput
    {
        /// <summary>
        ...
        public TankControllerInput(Vector3 position, Space owningSpace, Camera camera, Game game, /*DemosGame game, ModelDrawer drawer,*/ Model wheelModel, Texture2D wheelTexture)
        {

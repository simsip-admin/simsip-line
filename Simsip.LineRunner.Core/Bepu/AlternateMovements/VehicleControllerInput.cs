...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    /// </summary>
    public class VehicleControllerInput
    {
        /// <summary>
        ...
        public VehicleControllerInput(Vector3 position, Space space, Camera camera, Game game, /* DemosGame game, ModelDrawer drawer,*/ Model wheelModel, Texture2D wheelTexture)
        {

...
namespace BEPUphysicsDemos.AlternateMovement
{
    ...
    /// </summary>
    public class FirstPersonControllerInput : IControllerInput
    {
        /// <summary>
        ...
        public FirstPersonControllerInput(Space owningSpace, Camera camera, Game game /*DemosGame game*/ )
        {
            TheCharacterController = new CharacterController();
            TheCamera = camera;
            TheCameraControlScheme = new CharacterCameraControlScheme(TheCharacterController, camera, game);
        ...
        public void Activate()
        {
            if (!IsActive)
            {
                ...
                var cameraControlScheme = TheCameraControlScheme as CharacterCameraControlScheme;
                TheCharacterController.Body.Position = ConversionHelper.MathConverter.Convert(TheCamera.Position) - new Vector3(0, cameraControlScheme.StandingCameraOffset, 0);
            }
        }

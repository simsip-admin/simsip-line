...
namespace BEPUphysicsDemos
{
    public class ChaseCameraControlScheme : CameraControlScheme
    {
        ...
        public ChaseCameraControlScheme(Entity chasedEntity, Vector3 offsetFromChaseTarget, bool transformOffset, float distanceToTarget, Camera camera, Game game /* DemosGame game*/)
            : base(camera, game)
        {
        ...
        public override void Update(float dt)
        {
            ...
            Vector3 backwards = ConversionHelper.MathConverter.Convert(-Camera.ViewDirection);
            ...
            Camera.Position = ConversionHelper.MathConverter.Convert(lookAt + (Math.Max(cameraDistance - ChaseCameraMargin, 0)) * backwards); //Put the camera just before any hit spot.

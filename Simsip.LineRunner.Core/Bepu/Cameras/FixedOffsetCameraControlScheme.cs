...
namespace BEPUphysicsDemos
{
    public class FixedOffsetCameraControlScheme : CameraControlScheme
    {
        ...
        public FixedOffsetCameraControlScheme(Entity entity, Camera camera, Game game /*DemosGame game*/)
            : base(camera, game)
        {
            Entity = entity;
        ...
        public override void Update(float dt)
        {
            ...
            Camera.Position = ConversionHelper.MathConverter.Convert(Entity.Position + Matrix3x3.Transform(CameraOffset, Entity.OrientationMatrix));

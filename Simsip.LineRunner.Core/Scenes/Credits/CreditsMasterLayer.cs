...
#endif
            var creditsTitle = new CCLabelTTF(creditsText, GameConstants.FONT_FAMILY_NORMAL, GameConstants.FONT_SIZE_NORMAL);
            creditsTitle.Scale = GameConstants.FONT_SIZE_NORMAL_SCALE;

...
namespace TomShane.Neoforce.Controls
{
  ...
  public class ComboBox: TextBox
  {
    ...
    List<OutputType> ConvertAll<InputType, OutputType>(List<InputType> inputList, Func<InputType, OutputType> converter)
    {
        var output = new List<OutputType>(inputList.Count);

...
namespace TomShane.Neoforce.Controls
{
    ...
    public class Manager : DrawableGameComponent
    {
...
#if NETFX_CORE
        public async virtual void SetSkinAsync(string name)
        {
            Skin skin = await Skin.FactorySkin(this, name);
            SetSkin(skin);
        }
#endif
        ////////////////////////////////////////////////////////////////////////////        
        ...
        ////////////////////////////////////////////////////////////////////////////     
#if NETFX_CORE
        private void HandleUnhadledExceptions(object sender, Exception e)
        {

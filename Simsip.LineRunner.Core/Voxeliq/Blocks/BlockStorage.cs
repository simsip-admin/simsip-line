...
namespace Engine.Blocks
{
    ...
    public class BlockStorage : GameComponent, IBlockStorage
    {
        ...
        public void SetBlockAt(int x, int y, int z, Block block)
        {
            ...
            var physicsCollidable = block.PhysicsCollidable;
            if (physicsCollidable != null)
            {
                physicsCollidable.WorldTransform =
                    new RigidTransform(new BEPUutilities.Vector3(x + 0.5f, y + 0.5f, z + 0.5f));
                chunk.PhysicsStaticGroup.Shape.Add(physicsCollidable);
            }
        }

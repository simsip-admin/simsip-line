...
namespace Engine.Graphics.Texture
{
    ...
    public static class TextureHelper
    {
        ...
        /// </summary>
        public static readonly Dictionary<int, Vector2[]> BlockTextureMappings = new Dictionary<int, Vector2[]>();

        /// <summary>
        /// Provides uv-mappings for crack effects.
        /// </summary>
        public static readonly Dictionary<int, Vector2[]> CrackTextureMappings = new Dictionary<int, Vector2[]>();
        ...
        private static Vector2[] GetBlockTextureMapping(int textureIndex, BlockFaceDirection direction)
        {
            ...
            var mapping = new Vector2[6]; // contains texture mapping for the two triangles contained.
            switch (direction)
            {
                case BlockFaceDirection.XIncreasing:
                    mapping[0] = new Vector2(xOffset, yOffset); // 0,0 // first triangle.
                    mapping[1] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset); // 1,0
                    mapping[2] = new Vector2(xOffset, yOffset + UnitBlockTextureOffset); // 0,1
                    mapping[3] = new Vector2(xOffset, yOffset + UnitBlockTextureOffset); // 0,1 // second triangle.
                    mapping[4] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset); // 1,0
                    mapping[5] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset + UnitBlockTextureOffset); // 1,1
                    break;

                case BlockFaceDirection.XDecreasing:
                    mapping[0] = new Vector2(xOffset, yOffset); // 0,0
                    mapping[1] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset); // 1,0
                    mapping[2] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset + UnitBlockTextureOffset); // 1,1
                    mapping[3] = new Vector2(xOffset, yOffset); // 0,0
                    mapping[4] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset + UnitBlockTextureOffset); // 1,1
                    mapping[5] = new Vector2(xOffset, yOffset + UnitBlockTextureOffset); // 0,1
                    break;

                case BlockFaceDirection.YIncreasing:
                    mapping[0] = new Vector2(xOffset, yOffset + UnitBlockTextureOffset); // 0,1
                    mapping[1] = new Vector2(xOffset, yOffset); // 0,0
                    mapping[2] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset); // 1,0
                    mapping[3] = new Vector2(xOffset, yOffset + UnitBlockTextureOffset); // 0,1
                    mapping[4] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset); // 1,0
                    mapping[5] = new Vector2(xOffset + UnitBlockTextureOffset, yOffset + UnitBlockTextureOffset); // 1,1
                    break;

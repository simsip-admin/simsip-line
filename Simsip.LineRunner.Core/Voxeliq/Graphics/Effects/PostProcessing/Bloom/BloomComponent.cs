...
namespace Engine.Graphics.Effects.PostProcessing.Bloom
{
    ...
    public class BloomComponent:DrawableGameComponent, IBloomService
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = this._assetManager.GetEffect(Asset.BloomExtractEffect);
            bloomCombineEffect = this._assetManager.GetEffect(Asset.BloomCombineEffect);
            gaussianBlurEffect = this._assetManager.GetEffect(Asset.GaussianBlurEffect);

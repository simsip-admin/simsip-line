...
namespace Engine.Chunks
{
    ...
    public sealed class Chunk : IInGameDebuggable
    {
        ...
        public StaticGroup PhysicsStaticGroup;
        ...
        public void DrawInGameDebugVisual(GraphicsDevice graphicsDevice, Camera camera, SpriteBatch spriteBatch, SpriteFont spriteFont)
        {
            ...
            var projected = graphicsDevice.Viewport.Project(Vector3.Zero, camera.ProjectionMatrix, camera.ViewMatrix,
            ...
            BoundingBoxRenderer.Render(this.BoundingBox, graphicsDevice, camera.ViewMatrix, camera.ProjectionMatrix, Color.DarkRed);
        }

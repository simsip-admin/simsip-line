...
{
    public class ReadyQ: DebugGraph
    {
        // required services
        private IStatistics _statistics;

        public ReadyQ(Game game, Rectangle bounds)
            : base(game, bounds)
        {
        }
        ...
        {
            GraphValues.Add(this._statistics.ReadyQueue);
            ...
            CurrentValue = this._statistics.ReadyQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "readyQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);

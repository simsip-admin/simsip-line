...
{
    public class LightenQ: DebugGraph
    {
        // required services
        private IStatistics _statistics;

        public LightenQ(Game game, Rectangle bounds)
            : base(game, bounds)
        {
        }
        ...
        {
            GraphValues.Add(this._statistics.LightenQueue);
            ...
            CurrentValue = this._statistics.LightenQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "lightenQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);

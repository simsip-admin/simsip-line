...
{
    public class BuildQ: DebugGraph
    {
        // required services
        private IStatistics _statistics;

        public BuildQ(Game game, Rectangle bounds)
            : base(game, bounds)
        {
        }
        ...
        {
            GraphValues.Add(this._statistics.BuildQueue);
            ...
            CurrentValue = this._statistics.BuildQueue;
        ...
        {
            SpriteBatch.DrawString(SpriteFont, "buildQ:" + CurrentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);

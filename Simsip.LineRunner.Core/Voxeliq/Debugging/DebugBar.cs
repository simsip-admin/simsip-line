...
namespace Engine.Debugging
{
    ...
    /// </summary>
    public interface IStatistics : IUpdateable, IDrawable
    {
        /// <summary>
        /// Returns current FPS.
        /// </summary>
    ...
    public class DebugBar : DrawableGameComponent, IStatistics
    {
        // internal counters.
        ...
        // for grabbing internal string, we should init string builder capacity and max capacity ctor so that, 
        // grabbed internal string is always valid. - 
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _stringBuilder.Append(this._inputManager.ThePlayerControllerInput.FlyingEnabled ? "On" : "Off");
            ...
            _stringBuilder.Append(this._inputManager.PlayerCamera.Position);

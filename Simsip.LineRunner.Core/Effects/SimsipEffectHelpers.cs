...
namespace Simsip.LineRunner.Effects
{
    ...
    /// </summary>
    internal static class SimsipEffectHelpers
    {
        /// <summary>
        ...
        /// </summary>
        internal static SimsipEffectDirtyFlags SetWorldViewProjAndFog(SimsipEffectDirtyFlags dirtyFlags,
                                                                ...
                                                                EffectParameter worldViewProjParam, EffectParameter fogVectorParam)
        {
            ...
            if ((dirtyFlags & SimsipEffectDirtyFlags.WorldViewProj) != 0)
            {
            ...
            if (fogEnabled)
            {
                ...
                if ((dirtyFlags & (SimsipEffectDirtyFlags.Fog | SimsipEffectDirtyFlags.FogEnable)) != 0)
                {
                    SetFogVector(ref worldView, fogStart, fogEnd, fogVectorParam);

                    dirtyFlags &= ~(SimsipEffectDirtyFlags.Fog | SimsipEffectDirtyFlags.FogEnable);
                }
            }
            else
            {
                // When fog is disabled, make sure the fog vector is reset to zero.
                if ((dirtyFlags & SimsipEffectDirtyFlags.FogEnable) != 0)
                {
                    fogVectorParam.SetValue(Vector4.Zero);

                    dirtyFlags &= ~SimsipEffectDirtyFlags.FogEnable;
                }
            }
        ...
        /// </summary>
        internal static SimsipEffectDirtyFlags SetLightingMatrices(SimsipEffectDirtyFlags dirtyFlags, ref Matrix world, ref Matrix view,
                                                             EffectParameter worldParam, EffectParameter worldInverseTransposeParam, EffectParameter eyePositionParam)
        {
            ...
            if ((dirtyFlags & SimsipEffectDirtyFlags.World) != 0)
            {
                ...
                dirtyFlags &= ~SimsipEffectDirtyFlags.World;
            }

            // Set the eye position.
            if ((dirtyFlags & SimsipEffectDirtyFlags.EyePosition) != 0)
            {
                Matrix viewInverse;
                ...
                dirtyFlags &= ~SimsipEffectDirtyFlags.EyePosition;
            }
